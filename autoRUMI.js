...
(function () {
    ...
    (ticket.tags.includes('morocco') || ticket.tags.includes('tc_morocco' || ticket.tags.includes('__dc_country___morocco__'))) {
            ...
            } else if (!settings.actionTypes.casablanca && ticket.tags && ticket.tags.includes('morocco')) {
